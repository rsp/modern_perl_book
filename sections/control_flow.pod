...
evaluate to false.  Scalars containing C<undef>, the numbers 0 and 0.0, and the
empty string and string "0" (but not "0.0" or "00" or "0\n") evaluate to false.
Everything else is true, in the absence of deeper magic.
...
block once for every value of a list:
